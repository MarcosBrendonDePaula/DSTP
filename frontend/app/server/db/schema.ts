...
export interface FlowNode {
  id: string
  type: 'trigger' | 'condition' | 'action' | 'delay' | 'get_player' | 'find_player' | 'memory' | 'http_request' | 'set_variable' | 'script' | 'wait' | 'ui_menu' | 'ui_rule' | 'ui_builder' | 'ui_panel' | 'ui_col' | 'ui_row' | 'ui_tabs' | 'ui_text' | 'ui_icon' | 'ui_image' | 'ui_button' | 'ui_bar' | 'ui_spacer'
