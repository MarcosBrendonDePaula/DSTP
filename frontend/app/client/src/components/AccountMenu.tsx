...
import { LuSettings, LuKey, LuLogOut } from 'react-icons/lu'
    ...
    <>
      <div ref={ref} className="relative">
        <button
          ...
          title="Conta"
        >
          <LuSettings className="w-3.5 h-3.5 inline-block" />
        </button>
        {open && (
          <div className="absolute right-0 mt-1 w-48 bg-[#141414] border border-white/10 rounded-lg shadow-xl shadow-black/50 z-50 overflow-hidden">
            ...
            >
              <LuKey className="w-3.5 h-3.5 inline-block mr-1" /> Mudar senha
            </button>
            <button
            ...
            >
              <LuLogOut className="w-3.5 h-3.5 inline-block mr-1" /> Sair deste servidor
            </button>
          </div>
        )}
      </div>
    ...
    <div className="fixed inset-0 z-[70] flex items-center justify-center px-4" onClick={onClose}>
      ...
      >
        <div className="flex items-center gap-2 mb-1">
          <LuKey className="w-4 h-4 text-zinc-300" />
