...
export const meta: NodeMeta = {
  ...
  aiParamDescriptions: {
    ...
    operation: 'uppercase | lowercase | trim | length | number | round | add | sub | mul | div | json_parse | json_stringify',
    operand: 'Second operand for math ops (add/sub/mul/div).',
  },
  kind: 'data',
  defaults: { params: { value: '', operation: 'uppercase', operand: '' } },
  outputSchema: {
