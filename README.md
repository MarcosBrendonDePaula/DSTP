...
- **Sandbox do DST:** `TheSim:QueryServer` só permite `127.0.0.1`/`localhost`. Para hospedar central (um backend, vários servidores), cada host roda o **`relay/`** (forwarder Bun) que escuta local e repassa ao backend.
